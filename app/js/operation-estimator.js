...
(function () {
  ...
  ["undo", "redo", "new", "load", "layerAdd", "layerDelete", "layerMove",
   ...
   "spineSceneAdd", "spineSceneRename", "spineSceneMove",
   "spineSceneRemove", "spineBeatAdd", "spineBeatRename", "spineBeatMove",
   "spineBeatSplit", "spineBeatMerge", "spineBeatRemove", "panelAdd",
   "panelMove", "panelRemove", "panelDuration", "boardsSelect",
